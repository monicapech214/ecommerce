...
<html lang="en">
    ...
    <body>
        ...
        <!-- Section-->
        <section class="py-5">
        <h1 class="m-0 text-center text-black">Historia de IcaShop </h1>
        <br>
        <p class="m-0 text-center text-black" > Contamos con más de 40 años de experiencia en la industria del calzado en México,</p>
        <p class="m-0 text-center text-black" > la cual nos permite mantener una alianza con nuestros proveedores</p>
        <p class="m-0 text-center text-black" > para ofrecerte calidad y moda a precios muy competitivos.  Miles de socios</p>
        <p class="m-0 text-center text-black" > nos respaldan como una excelente opción para generar ingresos</p>
